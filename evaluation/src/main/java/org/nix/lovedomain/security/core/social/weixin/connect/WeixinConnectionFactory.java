...
public class WeixinConnectionFactory extends OAuth2ConnectionFactory<Weixin> {
    ...
    /**
     * @param accessGrant
     * @return org.springframework.social.connect.Connection<org.nix.lovedomain.security.core.social.weixin.api.Weixin>
     * @description 创建就链接
     * @author zhangpe0312@qq.com
     * @date 2019/2/1
     * @see OAuth2ConnectionFactory#createConnection(AccessGrant)
     */
     ...
     * @author zhangpe0312@qq.com
     * @date 2019/2/1
     * @see OAuth2ConnectionFactory#createConnection(ConnectionData)
     */
    @Override
